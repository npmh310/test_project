                            ...
                            <div class="row">
                                <aside class="col-sm-5 border-right">
                                    <article class="gallery-wrap"> 
                                        ...
                                        <div class="img-small-wrap">
                                            <div class="item-gallery"> <img src="${detail.image}"> </div>
                                            <div class="item-gallery"> <img src="${detail.image}"> </div>
                                            <div class="item-gallery"> <img src="${detail.image}"> </div>
                                            <div class="item-gallery"> <img src="${detail.image}"> </div>
                                        </div> <!-- slider-nav.// -->
                                ...
                                <aside class="col-sm-7">
                                    <article class="card-body p-5">
                                        ...
                                        <hr>
                                        <a href="#" class="btn btn-lg btn-primary" style="background: #c82333; color: white"> Buy now </a>
                                        <a href="#" class="btn btn-lg btn-outline-primary " style="background: #fac437; color: #9e0d23"> <i class="fa fa-shopping-cart"></i> Add to cart </a>
                                    </article> <!-- card-body.// -->
                                </aside> <!-- col.// -->
                            </div> <!-- row.// -->
                        </div> <!-- card.// -->
